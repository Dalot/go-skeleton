...
build: deps
	ENV=${ENV} CGO_ENABLED=0 $(GO) build -ldflags="-X 'github.com/dalot/go-skeleton/handlers.version=$$(git rev-parse HEAD)' -X 'github.com/dalot/go-skeleton/handlers.buildTime=$$(date -R)'"
